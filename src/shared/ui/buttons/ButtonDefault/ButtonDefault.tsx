  ...
  return (
    <button
      className={clsx([
        ...
        theme === ButtonDefaultTypes.Accent && 'border text-white bg-blue-600 border-blue-600 hover:bg-blue-700 active:bg-blue-800 active:border-blue-800 disabled:text-gray-500 disabled:bg-blue-100 disabled:border-blue-100',
        theme === ButtonDefaultTypes.Warning && 'border text-white bg-rose-600 border-rose-600 hover:bg-rose-700 active:bg-rose-800 active:border-rose-800 disabled:text-gray-500 disabled:bg-rose-100 disabled:border-rose-100',
        className,
      ])}
      {...otherProps}
    >
