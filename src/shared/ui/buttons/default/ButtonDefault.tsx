  ...
  return (
    <button
      className={clsx([
        ...
        theme === ButtonDefaultTypes.Accent && 'font-semibold shadow text-white bg-blue-600 hover:bg-blue-700 active:bg-blue-800 disabled:text-gray-500 disabled:bg-blue-100',
